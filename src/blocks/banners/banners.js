document.addEventListener("DOMContentLoaded", function(){
  ...
  banners.forEach(function(item){
    bannerTimesWrapper = item.querySelector(".banner__times-wrapper"),
     bannerTimes = bannerTimesWrapper.querySelectorAll("div.banner__time"),
     bannerOverflowBtn = item.querySelector(".banner__more-button");
